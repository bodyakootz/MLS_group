...
function dir_path($path='root') {
    if ('layout' == $path) {
        return public_path().DIRECTORY_SEPARATOR.'img'.DIRECTORY_SEPARATOR;
    } elseif ('carousel' == $path) {
        return public_path().DIRECTORY_SEPARATOR.'img'.DIRECTORY_SEPARATOR.'carousel';
    } elseif ('articles' == $path) {
        return public_path().DIRECTORY_SEPARATOR.'img'.DIRECTORY_SEPARATOR.'articles'.DIRECTORY_SEPARATOR;
    } elseif ('estates' == $path) {
